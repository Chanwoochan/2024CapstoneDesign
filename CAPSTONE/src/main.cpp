...
int main()
{
    ...
    // if(openSerialPort(&mt,"/dev/ttyUSB1")==-1) return -1;
    // serialSetting(&mt, newtio);
    ...
    while(true)
    {
        ...
        std::cout << "state : " << std::hex << (int)((unsigned char)(buf[14])<<8|(unsigned char)(buf[15])) << std::dec << "\n";
    ...
    while(true)
    {
        ...
        std::cout << "motor6: " << motor[5] << "\t";
        std::cout << "motor7: " << motor[6] << "\t";
        std::cout << "state : " << std::hex << (int)((unsigned char)(data[14])<<8|(unsigned char)(data[15])) << std::dec << "\n";
